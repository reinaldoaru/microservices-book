...
public interface ScoreRepository extends CrudRepository<ScoreCard, Long> {
    ...
    /**
     * Gets the total score for a given user: the sum of the scoes of all
     * their ScoreCards.
     * 
     ...
     * 
     * @return the leader boad, soted by highest score first.
     */
    @Query(
    ...
    /**
     * Retrieves all the ScoreCards for a given user, identified by hsi user id.
     * 
     * @param userId the id of the user.
